...
### 目的
为了解决情侣之间吃饭沟通中的各种小问题，如不知道吃什么（精确给出两人都想吃的）等问题。

---
### 需求

1. 吃什么推荐：先让两人分别用 3 个 emoji 形容今晚的胃口（🌶️🍜🥩），系统用 emoji 向量相似度做匹配，再转一次“加权转盘”——默契度越高，共同想吃的菜系在转盘上面积越大。把“吃什么”拆成两步：先默契测试，再随机惊喜，既解决选择困难，又增加互动。
